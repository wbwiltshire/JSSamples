...
var todayAsNumber = Number(today);
var mDateTimeString = moment().format('MM/DD/YYYY HH:mm')
console.log("\tToday: " + mDateTimeString.toString());
mDateTimeString = moment(todayAsNumber).format('MM/DD/YYYY HH:mm')
console.log("\tToday: " + mDateTimeString.toString());
dateTimeAsNumber = 1629588600 * 1000;
mDateTimeString = moment(dateTimeAsNumber).format('MM/DD/YYYY HH:mm')
console.log("\tDateTime: " + mDateTimeString.toString());
